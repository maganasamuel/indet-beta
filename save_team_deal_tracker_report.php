...
//Insert into record
$sql="INSERT INTO team_deal_tracker_reports (team_id,report_data,pay_date,date_from,date_to,date_created,created_by) 
VALUES ('$team_id',$report_data,$pay_date,$date_from,$date_to,$now,'$created_by')"; 
