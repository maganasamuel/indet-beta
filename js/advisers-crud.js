        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.date_hired != "" && data.date_hired != undefined) {
                    $('#date_hired').val(TimestampToNZFormat(data.date_hired));
                } else {
                    $('#date_hired').val("");
                }
                ...
                if (data.termination_date != "" && data.termination_date != undefined) {
                    $('#termination_date').val(TimestampToNZFormat(data.termination_date));
                } else {
    ...
    $('#btn-delete-confirm').on("click", function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                table.row("#adviser" + mat_id).remove().draw(false);
                $('#confirmModal').modal('hide');
            },
            error: function (data) {
                console.log(data);
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (state == "add") { //if user added a new record
                    tbl_r = table.row.add(newData).node().id = "adviser" + data.id;
                    table.row("#adviser" + data.id).data(newData).draw(false);
