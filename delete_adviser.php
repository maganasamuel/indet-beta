...
$updateTL="UPDATE adviser_tbl SET manager_id='0',manager_pct='0' WHERE manager_id=$del_id";
...
$querypdf="DELETE FROM pdf_tbl WHERE adviser_id=$del_id";
...
$query="DELETE FROM adviser_tbl WHERE id=$del_id";
if($del_id=="all"){
$query="TRUNCATE adviser_tbl";
	...
	mysqli_query($con, 'TRUNCATE summary_tbl');
...
if (mysqli_query($con, $query)) {
    ...
    header("Location: adviser_profiles.php");
