...
//Insert into record
$sql="INSERT INTO deals_report (adviser_id,type,schedule_type,filterdata,report_data,date_from,date_to,date_created,created_by) 
VALUES ('$adviser_id','$type','$schedule_type',$description,$report_data,$date_from,$date_to,$now,'$created_by')"; 

if (mysqli_query($con, $sql)) {
    echo "Success inserting record." . $sql;
}else{
	echo $sql;
