            ...
            <div class="col-sm-12" >
                <div class="tab-content">
                    ...
                    <div id="leadgen_graphs" class="tab-pane fade">            
                        ...
                        <canvas id="lead-generation-quarterly-kiwisaver" width="800" height="450"></canvas>
                        <canvas id="lead-generation-quarterly-kiwisaver-api" width="800" height="450"></canvas>  
                    </div>
                </div>
            </div>
        </div>
