    ...
    var new_deal = '\
        <div class="row"  id="deal_' + dealsCount + '" style="display:none;">\
            ...
            <div class="row">\
              ...
              <div class="col-sm-3" style="display:none;" id="clawback_div_' + dealsCount + '">\
                <div class="row">\
                  <div class="col-sm-4">\
                    Clawback Date\
                  </div>\
  ...
  <div>
    ...
    <form method="POST" class="margined">
      ...
      <div class='row' style="padding-top: 30px;">
        <div class='col-sm-2'>
          <h3 class="total_api" style="display: none;">Issued API: </h3>
        </div>
        <div class='col-sm-2'>
          <h3 class="total_api" style="display: none;" id="total_api">$0.00</h3>
        </div>
        <div class='col-sm-4'>
    ...
    $edit_id =  $_GET['edit_id'];
      if (isset($_POST["enter"])) {
        ...
        if ($first_issued_date != "0") {
          ...
          $sql = "UPDATE issued_clients_tbl SET leadgen = $leadgen, assigned_to = $adviser, issued = $total_issued, date_issued = $first_issued_date WHERE name = $client_id";
          ...
          if (empty($errors)) {
            ...
            header("Location:edit_issued_client.php?edit_id=$edit_id&success");
            //ob_end_flush();
          } else {
      ...
      window.location = 'edit_issued_client.php?edit_id=$edit_id';
      </script>";
      }
      ?>
  </div>
