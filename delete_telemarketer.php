...
$querypdf="DELETE FROM telemarketer WHERE id=$del_id";
...
$query="DELETE FROM telemarketer WHERE id=$del_id";
if($del_id=="all"){
$query="TRUNCATE telemarketer";
...
//	mysqli_query($con, 'TRUNCATE pdf_tbl');
	...
	mysqli_query($con, 'TRUNCATE telemarketer');
...
if (mysqli_query($con, $query)) {
    ...
    header("Location: telemarketer_profiles.php");
