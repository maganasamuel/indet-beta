...
function BirthdayEmail($email, $name, $adviser, $deal, $primary, $con, $index)
{
    ...
    $message .= '
        <hr>
        <small>
            Don\'t like receiving our emails? Click this <a href="http://onlineinsure.co.nz/indet/unsubscribe?id=' . $submissions_id . "&key=" . $unsub_key . '&primary=true">link</a> to unsubscribe.
        </small>
        ';
