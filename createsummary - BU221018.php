...
array_push($name_arr,preg_replace("/\([^)]+\)/","",$name));
...
$query = "SELECT * FROM summary_tbl where adviser_id IN (".$stringarr.") AND entrydate<='$myuntil_date'AND entrydate>='$mystart_date' ORDER BY entrydate ASC ";
