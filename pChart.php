<?php   
 ...
 include("libs/plugins/pChart2.1.4/class/pData.class.php");
 include("libs/plugins/pChart2.1.4/class/pDraw.class.php");
 include("libs/plugins/pChart2.1.4/class/pImage.class.php");
