...
$last_index=0;
	...
	$pdf->Ln(1);
	$pdf->Row(array("",htmlspecialchars_decode($lead_data->notes),""),true,array(190,215,239));
	$pdf->Rect(10,$pdf->GetY(),197,1,"FD");
	$pdf->Ln(1);
...
//$pdf->Output($path,'F');
$pdf->Output("I",$lead_data->client_name . " Data.pdf");
...
$file['link']=$path;
$file['filename']=$mix;
$file['lead_data'] = json_encode($lead_data);
