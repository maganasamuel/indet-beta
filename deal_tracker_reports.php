 <?php
 		...
 		<div align="center">
 			...
 			<div>
 				...
 				<?php require "database.php";
						...
						$query = "SELECT *, d.id as deal_id, a.id as adviser_id FROM deal_tracker_reports d LEFT JOIN adviser_tbl a ON d.adviser_id = a.id ORDER BY date_created DESC";
	...
	<tr>
		...
		";
 								...
 								<td><a class="a_single_view btn btn-primary" target="_blank" href="deal_tracker<?php echo "?id=$deal_id" ?>" data-toggle="tooltip" title="View Deal Tracker Report"><span class="glyphicon glyphicon-search" style="font-size:15px;"></span>
 									</a></td>

 								<td><a class="a_single" href="delete_deal_tracker_report.php<?php echo "?deal_id=$deal_id" ?>" data-toggle="tooltip" title="Delete Report"><img src="delete.png" /></a></td>
