<?php   
 ...
 $myPicture->setFontProperties(array("FontName"=> realpath("../fonts/Silkscreen.ttf"),"FontSize"=>6));
 ...
 $myPicture->drawLine(370,160,650,160,array("R"=>0,"G"=>0,"B"=>0,"Ticks"=>1,"Weight"=>1));
