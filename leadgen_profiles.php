...
<div align="center">
  <div class="jumbotron">
    <h2 class="slide">Lead Generator Profiles</h2>
</div>
...
?>
	...
	<th><a class="a_single" href="delete_leadgen.php<?php echo "?del_id=$id"?>" ><img src="delete.png" /></a></th>
<th><a href="edit_leadgen.php<?php echo "?edit_id=$id"?>"><img src="edit.png"></a>	 </th>
