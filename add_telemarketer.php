...
<!--nav bar end-->
  ...
  <div class="jumbotron">
    <h2 class="slide">Add Telemarketer</h2>
</div>
...
<div class="row" style="padding-top: 30px;">
  ...
  <div class="row">
	...
	<input name="enter" class="btn btn-info center" type="submit" value="Add Telemarketer" style="width: 100%;"/>
</div>
</div>
...
VALUES ('$name','Telemarketer')"; 


if(mysqli_query($con,$sql)){
  
  echo "<script>alert('Telemarketer successfully added!');</script>";
  header("Refresh:0");
  ob_end_flush();
