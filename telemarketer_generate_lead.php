<?php
    ...
    $time = $date_helper->CommonTimeToMilitaryTime($client_data->appointment_hour . ":" . $client_data->appointment_minute . " " . $client_data->appointment_period);
    ...
    $sql ="INSERT INTO clients_tbl (name,appt_date,appt_time,time,address,city,zipcode,lead_by,leadgen,assigned_to,assigned_date,notes,date_submitted,creation_date) 
    VALUES ('$name','$appt_date','$phone','$time','$address','$city','$zipcode','$lead_by','$leadgen','$assigned_to','$assigned_date','$notes','$date_submitted','$creation_date')";
